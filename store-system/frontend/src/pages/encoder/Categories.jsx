...
import { Plus, X, Download, Tag, Info } from 'lucide-react';
      ...
      <div className="glass-card min-h-full">
        ...
        <div className="table-wrapper">
          <table className="glass-table">
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan="2" className="text-center p-8">Loading categories...</td></tr>
              ) : categories.length === 0 ? (
                <tr><td colSpan="2" className="text-center p-8 text-muted">No categories found. Create one.</td></tr>
              ) : (
                categories.map(c => (
                  <tr key={c.id}>
